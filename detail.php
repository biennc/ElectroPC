							...
							<div class="product-details">
								...
								<form id="add-to-cart-form" action="cart.php?action=add" method="post">
									<div class="add-to-cart">
										<div class="qty-label">
											<input class='qty-label-border' type="number" min="1" name="quantity[<?php echo $row_pro['ID'] ?>]" value="1">
							...
							<div class="col-md-8">
								<div id="reviews">
									...
									?>										<ul class="reviews">
											...
											<!-- Admin Reply -->
											<?php if(!empty($row_comment['Rep_comment'])) { ?>
											<li style="margin-left: 30px; position: relative;">
												<div class="review-heading" style="margin-bottom: 10px;">
													<h5 class="name">
														<i class="fa-solid fa-play" style="margin-right: 4px;"></i>
														Admin
													</h5>
													<p class="date" style="color: #8D99AE; font-size: 10px; margin: 0;">
														<?php echo $row_comment['datetime'] ?>
													</p>												
												</div>
												<div class="review-body">
													<p><?php echo $row_comment['Rep_comment'] ?></p>
												</div>
											</li>
											<?php } ?>
										</ul>
