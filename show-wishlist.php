            ...
            <div id="responsive-nav">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li><a href="danhsachhanghoa.php?category_id=<?php echo $row['id'] ?> "><?php echo $row['tendanhmuc']; ?>
                                &nbsp;</a></li>
    ...
    <div class="container">
        ...
        <table>
            <tr>
                ...
                <th class="product-add-cart">Thêm vào giỏ hàng</th> <!-- Thêm cột mới -->
            </tr>
            <?php
            if (isset($_SESSION['user_id'])) {
                ...
                while ($row = mysqli_fetch_assoc($result_wishlist)) {
                    ...
                    <tr>
                        ...
                        <td class="product-delete"><a
                                href="delete-wishlist.php?product_id=<?php echo $row['product_id'] ?>&user_id=<?php echo $_SESSION["user_id"] ?>">Xóa</a>
                        </td>
                        <td class="product-add-cart">
                            <form action="cart.php?action=add&id=<?php echo $row['product_id']; ?>" method="post"
                                style="margin:0;">
                                <input type="hidden" name="quantity[<?php echo $row['product_id']; ?>]" value="1">
